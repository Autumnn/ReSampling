...
for f_i in range(Num_Files):
    file = "Results\Result_a_" + str(f_i) + ".txt"
        ...
        for line in r:
            ...
            if i == 0 and f_i == 0:
                ...
                if f_i == 0:
                    ...
                    Accuracy[data_set][method].append(accuracy)
                    Precision[data_set][method].append(precision)
                    Recall[data_set][method].append(recall)
                    Specificity[data_set][method].append(specificity)
                    G_mean[data_set][method].append(g_mean)
                    F_mean[data_set][method].append(f_mean)
                    AUC[data_set][method].append(auc)
...
file_write = "Result_UCI_all_r_Analysis.txt"
